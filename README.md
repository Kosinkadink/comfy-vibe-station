...
| `ComfyUI-Launcher/` | [Comfy-Org/ComfyUI-Desktop-2.0-Beta](https://github.com/Comfy-Org/ComfyUI-Desktop-2.0-Beta) | ComfyUI Desktop 2.0 — Electron app for managing multiple ComfyUI installations |
| `ComfyUI-Launcher-Environments/` | [Comfy-Org/ComfyUI-Standalone-Environments](https://github.com/Comfy-Org/ComfyUI-Standalone-Environments) | Standalone environment definitions for ComfyUI Desktop 2.0 |
...
- [`extra-model-paths.md`](extra-model-paths.md) — How `extra_model_paths.yaml` works, how the desktop app uses it, and a proposed wildcard base-path feature
